...
- CI evidence: runs 36235684408, 36236215115, 36236707259 and 36237944922 each passed all five jobs (static analysis/typecheck/build, unit and contract tests, PostgreSQL/RLS rehearsal, adversarial/security, named-image Docker build/load/inspect/boot). 36237944922 is the green run for commit c482c84.
...
- PENDING_P2_SHARED_ROUTING is resolved: the shared P2 runtime is used for Marketing on this branch.
